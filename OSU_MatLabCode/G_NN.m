function [Resp_obs,Resp_gf,Resp_Recon,Resp_Error,GPP_obs,GPP_gf,GPP_Recon,GPP_Error,NEE_obs,NEE_gf,NEE_reconstructed,NEE_Error,Resp_Full,GPP_Full,NEE_Full]=G_NN(R,BadDataFlags,daynight,Dspk,Resp_obs,RespFillers,GPPFillers)
tic
